      ...
      <div className="flex flex-col lg:flex-row">
        <div className="mb-4 w-full text-center lg:w-[480px] lg:text-left">
          <div className="mb-8">
            ...
            <p className="text-sm leading-5">70 Hoi Yuen Rd, Kwun Tong, Hong Kong</p>
          </div>
          <div className="mb-8">
            <h2 className="mb-3 text-lg font-bold">EMAIL ADDRESS</h2>
            <p className="text-sm leading-5">
              <a href="mailto:kaiwang0119@gmail.com" rel="noopener" className="hover:text-yellow-600">
                kaiwang0119@gmail.com
              </a>
            </p>
          </div>
          <div className="mb-8">
